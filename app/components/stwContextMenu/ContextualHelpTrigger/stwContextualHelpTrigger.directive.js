...
function stwContextualHelpTrigger($rootScope, MenuController) {
...
stwContextualHelpTrigger.$inject = ['$rootScope', 'MenuController'];
module.exports = stwContextualHelpTrigger;
