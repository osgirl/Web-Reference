...
function stwContextMenuLeft(MenuController, $animateCss, $state, $rootScope, $location) {
...
stwContextMenuLeft.$inject = ['MenuController', '$animateCss', '$state', '$rootScope', '$location'];
